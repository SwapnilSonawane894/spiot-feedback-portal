...
const hodLinks: NavItem[] = [
  ...
  { href: "/hod/self-report", label: "My Report", icon: <User size={20} />, group: "reports" },
  { href: "/profile", label: "My Profile", icon: <User size={20} /> },
];

const principalLinks: NavItem[] = [
  { href: "/principal/dashboard", label: "Dashboard", icon: <LayoutDashboard size={20} /> },
  { href: "/principal/feedback-reports", label: "Feedback Reports", icon: <ClipboardCheck size={20} /> },
  { href: "/profile", label: "My Profile", icon: <UserCircle size={20} /> },
];
...
export default function ModernSidebar({ 
  ...
  const links = role === "HOD" ? hodLinks : role === "PRINCIPAL" ? principalLinks : role === "STUDENT" ? studentLinks : (role === "STAFF" || role === "FACULTY") ? staffLinks : adminLinks;
