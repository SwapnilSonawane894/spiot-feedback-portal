/* Centralized auth options for NextAuth
   Moved out of the route file to avoid exporting non-route symbols from a route module
*/
...
// Keep as `any` to avoid tight coupling with next-auth types in this codebase
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        const user = await userService.findUnique({ email: email });
